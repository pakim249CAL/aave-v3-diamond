...
library FlashLoanLogic {
   ...
   */
  function executeFlashLoan(DataTypes.FlashloanParams memory params)
    internal
  {
    ...
    ValidationLogic.validateFlashloan(params.assets, params.amounts);
