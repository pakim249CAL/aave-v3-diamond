...
library ReserveLogic {
  ...
  function cumulateToLiquidityIndex(
    ...
    uint256 result = (amount.wadToRay().rayDiv(
  ...
  function updateInterestRates(
    ...
    vars.totalVariableDebt = reserveCache
    ...
    reserve.currentVariableBorrowRate = vars
      .nextVariableRate
      .toUint128();
  ...
  function _accrueToTreasury(
    ...
    vars.prevTotalVariableDebt = reserveCache
      .currScaledVariableDebt
      .rayMul(reserveCache.currVariableBorrowIndex);

    //calculate the new total variable debt after accumulation of the interest on the index
    vars.currTotalVariableDebt = reserveCache
      .currScaledVariableDebt
      .rayMul(reserveCache.nextVariableBorrowIndex);

    //calculate the stable debt until the last timestamp update
    vars.cumulatedStableInterest = MathUtils
      .calculateCompoundedInterest(
    ...
    vars.prevTotalStableDebt = reserveCache
    ...
    returns (DataTypes.ReserveCache memory)
  {
    ...
    reserveCache.currVariableBorrowIndex = reserve
      .variableBorrowIndex;
    ...
    reserveCache.nextTotalStableDebt = reserveCache
      .currTotalStableDebt;
