...
library ValidationLogic {
  ...
  uint256 internal constant REBALANCE_UP_LIQUIDITY_RATE_THRESHOLD =
    0.9e4;

  // Minimum health factor allowed under any circumstance
  // A value of 0.95e18 results in 0.95
  uint256
    internal constant MINIMUM_HEALTH_FACTOR_LIQUIDATION_THRESHOLD =
    0.95e18;
   ...
   */
  uint256 internal constant HEALTH_FACTOR_LIQUIDATION_THRESHOLD =
    1e18;
  ...
  function validateBorrow(
    ...
    vars.collateralNeededInBaseCurrency = (vars
      .userDebtInBaseCurrency + vars.amountInBaseCurrency).percentDiv(
        vars.currentLtv
  ...
  function validateSwapRateMode(
    ...
    if (currentRateMode == DataTypes.InterestRateMode.STABLE) {
      ...
      currentRateMode == DataTypes.InterestRateMode.VARIABLE
    ) {
  ...
  function validateLiquidationCall(
    ...
    vars.isCollateralEnabled =
      collateralReserve.configuration.getLiquidationThreshold() !=
      0 &&
