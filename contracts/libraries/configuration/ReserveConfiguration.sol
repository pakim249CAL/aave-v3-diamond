...
library ReserveConfiguration {
  ...
  uint256 internal constant LIQUIDATION_THRESHOLD_START_BIT_POSITION =
    16;
  ...
  uint256
    internal constant STABLE_BORROWING_ENABLED_START_BIT_POSITION =
    59;
  uint256 internal constant IS_PAUSED_START_BIT_POSITION = 60;
  uint256
    internal constant BORROWABLE_IN_ISOLATION_START_BIT_POSITION = 61;
  ...
  uint256
    internal constant LIQUIDATION_PROTOCOL_FEE_START_BIT_POSITION =
    152;
  uint256 internal constant EMODE_CATEGORY_START_BIT_POSITION = 168;
  uint256 internal constant UNBACKED_MINT_CAP_START_BIT_POSITION =
    176;
  ...
  uint256 internal constant MAX_VALID_LIQUIDATION_PROTOCOL_FEE =
    65535;
  ...
  function setBorrowCap(
    ...
    require(
      borrowCap <= MAX_VALID_BORROW_CAP,
      Errors.INVALID_BORROW_CAP
    );
  ...
  function setSupplyCap(
    ...
    require(
      supplyCap <= MAX_VALID_SUPPLY_CAP,
  ...
  function setDebtCeiling(
    ...
    require(
      ceiling <= MAX_VALID_DEBT_CEILING,
      Errors.INVALID_DEBT_CEILING
    );
